...
export const areaChartData: ChartData = {
  data: [
    ...
    { month: 'Q3', sales: 18000, expenses: 10000 },
    { month: 'Q4', sales: 20000, expenses: 11000 },
  ],
  metadata: {
...
export const timeSeriesData: TimeSeriesDataPoint[] = [
  { timestamp: '2024-01-01T00:00:00Z', timezone: 'UTC', temperature: 20, humidity: 65 },
  { timestamp: '2024-01-01T06:00:00Z', timezone: 'UTC', temperature: 18, humidity: 70 },
  { timestamp: '2024-01-01T12:00:00Z', timezone: 'UTC', temperature: 25, humidity: 60 },
  { timestamp: '2024-01-01T18:00:00Z', timezone: 'UTC', temperature: 22, humidity: 68 },
  { timestamp: '2024-01-02T00:00:00Z', timezone: 'UTC', temperature: 19, humidity: 72 },
  { timestamp: '2024-01-02T06:00:00Z', timezone: 'UTC', temperature: 17, humidity: 75 },
  { timestamp: '2024-01-02T12:00:00Z', timezone: 'UTC', temperature: 24, humidity: 62 },
  { timestamp: '2024-01-02T18:00:00Z', timezone: 'UTC', temperature: 21, humidity: 70 },
];

export const monthlyRevenueData: ChartData = {
  data: [
    { month: 'January', revenue: 45000, profit: 12000 },
    { month: 'February', revenue: 52000, profit: 15000 },
    { month: 'March', revenue: 48000, profit: 13000 },
    { month: 'April', revenue: 61000, profit: 18000 },
    { month: 'May', revenue: 55000, profit: 16000 },
    { month: 'June', revenue: 67000, profit: 20000 },
  ],
  metadata: {
